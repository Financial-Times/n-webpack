...
const handlebarsConfig = {
	...
	extensions: ['.html'],
	helperDirs: [path.resolve('./node_modules/@financial-times/n-handlebars/src/helpers'), path.resolve('./server/helpers'), path.resolve('./node_modules/@financial-times/n-image/src/handlebars-helpers')],
